...
sui client ptb --move-call "${package_id}::locker::register_category" @${locker_cap_object_id} @${category_registry_object_id} \'${category_game_owners}\' --gas-budget 10000000
sui client ptb --move-call "${package_id}::locker::register_category" @${locker_cap_object_id} @${category_registry_object_id} \'${category_team_advisors}\' --gas-budget 10000000
